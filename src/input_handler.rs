...
impl InputHandler {
    ...
    pub fn handle_issue_task_orders() {
        // Issue task orders
    }

    pub fn handle_issue_captains_orders() -> Result<Command<bool>, String> {
    ...
    pub fn prompt_host_port() -> String {
        loop {
            let response: Result<String, io::Error> = InputHandler::prompt_user("What is the host port?");
